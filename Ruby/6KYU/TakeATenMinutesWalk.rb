...
# city block, so create a function that will return true if the walk the app gives you will take you exactly ten
...
# run
puts is_valid_walk(['n','s','n','s','n','s','n','s','n','s']) # -> true
puts is_valid_walk(['w','e','w','e','w','e','w','e','w','e','w','e']) # -> false
puts is_valid_walk(['w']) # -> false
puts is_valid_walk(['n','n','n','s','n','s','n','s','n','s']) # -> false
